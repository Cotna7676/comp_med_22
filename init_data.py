...
def run_train_model(model, model_desc, criterion, optimizer, num_epochs):
    # train model, get train/val acc/loss
    model, best_model_wts, train_loss, train_acc, val_loss, val_acc =\
                 train_model(model, criterion, optimizer, num_epochs)

    model_name = "artifacts/" + model_desc + "__" + str(num_epochs) + "_epochs"
...
def AlexNet(num_classes, num_epochs):
    ...
    run_train_model(model, "AlexNet", criterion, optimizer, num_epochs)
